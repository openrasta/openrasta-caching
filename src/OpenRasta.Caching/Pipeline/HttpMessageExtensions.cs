...
namespace OpenRasta.Caching.Pipeline
{
    ...
    {
        public static bool InvalidConditionalHeaders(this IRequest request, Action<IEnumerable<string>> erroneousCombination)
        {
        ...
        public static void HeaderDateTimeOffset(this IHttpMessage message, string header, Action<DateTimeOffset> onParse, Action<string> onParseError = null)
        {
